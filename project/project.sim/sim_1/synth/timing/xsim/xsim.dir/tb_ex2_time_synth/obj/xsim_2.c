...
{
	iki_relocate(dp, "xsim.dir/tb_ex2_time_synth/xsim.reloc",  (void **)funcTab, 1206);
	iki_vhdl_file_variable_register(dp + 1874920);
	iki_vhdl_file_variable_register(dp + 1874976);
...
{
	iki_sensitize(dp, "xsim.dir/tb_ex2_time_synth/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880592, dp + 2408536, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880536, dp + 2408928, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880480, dp + 2408816, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1881000, dp + 2409040, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880648, dp + 2408704, 0, 7, 0, 7, 8, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/tb_ex2_time_synth/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/tb_ex2_time_synth/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/tb_ex2_time_synth/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/tb_ex2_time_synth/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, isimBridge_getWdbWriter(), 0, argc, argv);
