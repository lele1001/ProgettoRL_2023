...
{
	iki_relocate(dp, "xsim.dir/tb_ex3_time_synth/xsim.reloc",  (void **)funcTab, 1206);
	iki_vhdl_file_variable_register(dp + 1874872);
	iki_vhdl_file_variable_register(dp + 1874928);
...
{
	iki_sensitize(dp, "xsim.dir/tb_ex3_time_synth/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880544, dp + 2408440, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880488, dp + 2408832, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880432, dp + 2408720, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880952, dp + 2408944, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1880600, dp + 2408608, 0, 7, 0, 7, 8, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/tb_ex3_time_synth/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/tb_ex3_time_synth/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/tb_ex3_time_synth/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/tb_ex3_time_synth/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, (void*)0, 0, isimBridge_getWdbWriter(), 0, argc, argv);
